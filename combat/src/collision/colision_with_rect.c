...
static int check_colision_1(sfVector2f rect_pos, sfVector2f rect_scale, sfVector2f pos)
{
...
static int check_colision_2(sfVector2f rect_pos, sfVector2f rect_scale, sfVector2f pos)
{
    if (pos.x < rect_pos.x && pos.x > rect_pos.x + rect_scale.x * 100) {
        if (pos.y > rect_pos.y && pos.y < rect_pos.y + rect_scale.y * 100) {
            return (1);
...
static int check_colision_3(sfVector2f rect_pos, sfVector2f rect_scale, sfVector2f pos)
{
    if (pos.x > rect_pos.x && pos.x < rect_pos.x + rect_scale.x * 100) {
        if (pos.y > rect_pos.y && pos.y < rect_pos.y + rect_scale.y * 100) {
            return (1);
...
static int check_colision_4(sfVector2f rect_pos, sfVector2f rect_scale, sfVector2f pos)
{
    if (pos.x < rect_pos.x && pos.x > rect_pos.x + rect_scale.x * 100) {
        if (pos.y < rect_pos.y && pos.y > rect_pos.y + rect_scale.y * 100) {
            return (1);
